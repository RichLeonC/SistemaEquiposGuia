...
export default function ActividadesForms() {
    ...
    const [form, setForm] = useState({
        ...
        nombre: '',
        semana: '',//combobox
        finalInicio: '',//mandar por parametro
        horaInicio: '',//mandar por parametro
        fechaCreacion: '',//mandar por parametro
        modalidad: '', //combobox
        enlaceReunion: '',
        responsable: '', //combobox tomado de la base de todos los profesores que formen parte del equipo
        afiche: '', //documento
        recordatorio: '', //fecha de recordatorios
