...
router.post('/', async (req, res) => {
    try {
      const { cedula,codigo,esCordinador, nombre, segundoNombre, apellido1, apellido2, correo, clave, celular, rol,idSede,telOficina,foto } = req.body;
  
      // Validamos los datos de entrada
      if (!cedula||!codigo||esCordinador || !nombre || !apellido1 || !apellido2 || !correo || !clave || !celular || !rol
